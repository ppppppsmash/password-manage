...
import { Label } from "@/components/effective-ui/label";
import { Input } from "@/components/effective-ui/input";
...
export function SignInForm() {
  ...
  return (
    <div className="max-w-lg w-full mx-auto rounded-none p-4 md:p-8 bg-white dark:bg-neutral-950">
      ...
      <p className="text-right">If you don't have a account, sign up{(' ')}
      <a
        className="text-neutral-500 hover:text-neutral-950 hover:no-underline transition duration-350 underline"
        href="/auth/signup/"
      >here</a></p>
    </div>
  );
